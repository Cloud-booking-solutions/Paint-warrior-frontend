...
const About = () => {
  return (
    <div className="pt-20 py-10 bg-gray-00 mt-2 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* About Content */}
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          {/* Left Section - Image */}
          ...
          <div>
            ...
            <div className="mt-8">
              <Link
                to="/services"
                className="inline-block bg-yellow-500 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:bg-yellow-600 transition duration-300"
              >
                View Our Services
              </Link>
            </div>
        ...
        <div className="mt-10 bg-yellow-500 text-white p-6 lg:p-12 rounded-xl text-center shadow-xl">
          <h3 className="text-3xl lg:text-4xl font-extrabold">Our Expertise</h3>
